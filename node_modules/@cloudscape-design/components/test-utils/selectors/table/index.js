...
const styles_selectors_js_7 = require("../../../table/progressive-loading/styles.selectors.js");
...
class TableWrapper extends selectors_1.ComponentWrapper {
     ...
     */
    findRootItemsLoader() {
        const selector = `.${styles_selectors_js_7.default['items-loader']}[data-root="true"]`;
    ...
    findItemsLoaderByItemId(itemId) {
        const selector = `.${styles_selectors_js_7.default['items-loader']}[data-parentrow="${itemId}"]`;
        return this.find(selector);
    }
}
